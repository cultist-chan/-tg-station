...
datum/shuttle_manager/proc/move_shuttle(var/override_delay)
	...
	spawn(override_delay == null ? tickstomove*10 : override_delay)
		...
		toArea = locate(fromArea.destination) // the area the shuttle is going to
